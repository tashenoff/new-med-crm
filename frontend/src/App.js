        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
            <h3 className="text-lg font-semibold mb-4 text-red-700">
              ⚠️ Требуется создание медицинской карты
            </h3>
            
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
              <p className="text-sm text-yellow-800">
                Для записи на прием необходимо сначала создать медицинскую карту пациента.
                Заполните основные медицинские данные ниже.
              </p>
            </div>
            ...
            <form onSubmit={handleSaveMedicalRecord} className="space-y-4">
              ...
              <div className="flex space-x-3">
                ...
                >
                  {loading ? 'Создание медкарты...' : 'Создать медкарту и записать на прием'}
                </button>
                <button
                  type="button"
                  onClick={() => {
