                ...
                <tbody>
                  {materials.map((material) => (
                    <tr key={material.id} className={`${tableRowClasses}`}>
                      ...
                      <td className={tableCellClasses}>{material.start_period}</td>
                      <td className={tableCellClasses}>{material.incoming}</td>
                      <td className={tableCellClasses}>{material.outgoing}</td>
                      <td className={tableCellClasses}>{material.inventory}</td>
                      <td className={tableCellClasses}>{material.balance}</td>
